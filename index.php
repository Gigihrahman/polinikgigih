...
<body>
    ...
    if (isset($_GET['page'])) {
        ...
        echo '<br><h2 class="d-flex justify-content-center">Selamat Datang di Sistem Informasi Poliklinik ';

        if (isset($_SESSION['username' . 'nama'])) {
            echo ", " . $_SESSION['username' . 'nama'] . "</h2><hr>";
        } else {
            echo '</h2  ><hr><div class="d-flex justify-content-center  " style="padding-top:100px">Silakan Login untuk menggunakan sistem. Jika belum memiliki akun silakan Register terlebih dahulu. </div>';
        }
    }
    ?>
</body>
